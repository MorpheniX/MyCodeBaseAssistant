...
class ChatToolWindowLandingPanel(onAction: (LandingPanelAction, Point) -> Unit) : ResponseMessagePanel() {
    ...
    private fun getWelcomeMessage(): String {
        return """
            ...
            Hi <strong>${GeneralSettings.getCurrentState().displayName}</strong>, I'm MCBA! You can ask me anything, but most people request help with their code. Here are a few examples of what you can ask me:
            </p>
            </html>
        """.trimIndent()
    }
